...
public class DeliveryMain extends Thread {
    ...
    private static DeliveryManager shopManager = new DeliveryManager(); // ShoppingManager 객체 생성
    ...
    public static void shopping() throws IOException {
        ...
        while (true) {
            ...
            // 모든 정보 입력 완료 객체 생성
            Delivery customer = new Delivery(id, name, item, Integer.parseInt(price), address, dateTimeString);
